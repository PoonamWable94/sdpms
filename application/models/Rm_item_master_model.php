...
class Rm_item_master_model extends CI_Model
{   
    var $table = 'tg_rm_item_master';     
    ...
    {           
        ...
        // $this->db->join('tg_main_group_master as p1','p1.id = sub_group_1_master.');
         $this->db->select('tg_rm_item_master.*, p1.main_group,p2.sub_group');  
         $this->db->join('tg_main_group_master as p1','p1.id = tg_rm_item_master.main_group_id');
         $this->db->join('sub_group_1_master as p2','p2.id = tg_rm_item_master.sub_group_id');
        // $this->db->where('sub_group_1_master.isDeleted',1);
         $this->db->where('tg_rm_item_master.isDeleted',1);
          $this->db->order_by('tg_rm_item_master.id','DESC');
