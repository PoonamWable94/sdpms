...
class Quality_test_type extends BaseController
{
    public function __construct()
    {
        parent::__construct();
        $this->load->model('quality_testtype_model');
        $this->isLoggedIn();   
    }
    
    public function index()
    {
        $this->global['pageTitle'] = 'Test Type';
        
       
        $this->loadViews("master/quality_master/test_type", $this->global, NULL , NULL);
    }

    public function ajax_list()
    {
        $list = $this->quality_testtype_model->get_datatables();
        ...
        $output = array(
                        "draw" => $_POST['draw'],
                        "recordsTotal" => $this->quality_testtype_model->count_all(),
                        "recordsFiltered" => $this->quality_testtype_model->count_filtered(),
                        "data" => $data,
                );
    ...
    {
        $data = $this->quality_testtype_model->get_by_id($id);
    ...
    public function ajax_add()
    {
        ...
        $insert = $this->quality_testtype_model->save($data);
    ...
    public function ajax_update()
    {
        ...
        $this->quality_testtype_model->update(array('id' => $this->input->post('id')), $data);
        echo json_encode(array("status" => TRUE));
    }
 
    public function ajax_delete($id)
    {
        $this->quality_testtype_model->delete_by_id($id);
        echo json_encode(array("status" => TRUE));
    }
    ...
    private function _validate()
    {
        ...
        {
            $data['inputerror'][] = 'test_type';
            $data['error_string'][] = 'Test Type  is required';
            $data['status'] = FALSE;
        }
	...
	{
        $this->quality_testtype_model->update_status($this->input->post('id'), $this->input->post('status'));
	}
}
