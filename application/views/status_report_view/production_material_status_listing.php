    ...
    <div id="page_content_inner">                
        <div class="md-card">        
            ...
            <div class="md-card-content">                
                <table id="dt_mytable" class="uk-table uk-table-align-vertical uk-table-nowrap uk-table-condensed tablesorter tablesorter-altair">
                        <thead>
                            <tr>
                                <th>Project No</th>
                                <!-- <th>Po Number<th>                            
                                ...
                                <?php 
                                    ...
                                    <th>
                                        <?php echo $activity->task; echo "<br>"; echo $activity->task_data; ?></th>        
            ...
            <div class="md-card-toolbar md-bg-cyan-300" data-toolbar-progress="100">
                <h1 class="md-card-toolbar-heading-text"> List Production Assembly Activity
                 </h1>
            </div>

            <div class="md-card-content">                
                <table id="dt_mytable2" class="uk-table uk-table-align-vertical uk-table-nowrap uk-table-condensed tablesorter tablesorter-altair">
                        <thead>
                            <tr>
                                <th>Project No</th>
                                <th>PN Number</th>
                                <th>PO Date</th>
                                <?php 
                                    foreach($assembly_activity_list as $assembly_activity){  ?>
                                    <th>
                                        <?php echo $assembly_activity->assembly_activity; echo "<br>"; echo $assembly_activity->assembly; ?>
                                    </th>        
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#dt_mytable').DataTable({ 
            ...
            "ajax": {
                "url": "<?php echo site_url('status_report/production_material_status/list_activity'); ?>",
                "type": "POST"
            },
    ...
    $(document).ready(function() {
        ...
        table = $('#dt_mytable2').DataTable({ 
            ...
            "ajax": {
                "url": "<?php echo site_url('status_report/production_material_status/list_assembly_activity'); ?>",
                "type": "POST"
            },
