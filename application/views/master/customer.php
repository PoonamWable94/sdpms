...
<div class="uk-modal" id="modal_default">
    <div class="uk-modal-dialog">
        ...
        <div class="uk-modal-header">
            <h3 class="uk-modal-title">Customer Details</h3>
        </div>
            ...
            <div class="uk-grid">
                <div class="uk-width-1-1">
                    <div class="parsley-row md-input-wrapper">
                        ...
                        <input type="text" name="customer_name" id="customer_name" required class="md-input label-fixed" />
                        <br>
                ...
                <div class="uk-width-1-1">
                    <div class="parsley-row md-input-wrapper">
                        <label for="gstin">GSTIN/UIN<span class="req">*</span></label>
...
<script type="text/javascript">
    ...
    $(document).on('click','.status_checks',function()
    {
        ...
        if(confirm("Are you sure to "+ msg))
        {
            ...
            var myurl="<?php echo base_url()."Customer/update_status"?>";
