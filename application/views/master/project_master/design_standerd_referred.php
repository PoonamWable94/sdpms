    ...
    <div id="page_content_inner">        
        <div class="md-card">
            <div class="md-card-toolbar md-bg-cyan-300" data-toolbar-progress="100">
                <h1 class="md-card-toolbar-heading-text"> Design Standerds Referred
                    <a href="javascript:void(0)" onclick="add_data()" data-uk-tooltip="{pos:'bottom'}" title="Add New Design standerd"><i class="md-icon material-icons md-color-white">&#xE146;</i></a>
                ...
                <table id="dt_mytable" class="uk-table uk-table-striped uk-table-hover uk-table-condensed">
                    <thead>
                        <tr>
                            ...
                            <th>Design Standerds Referred</th>
                            <th>Status</th>
        ...
        <div class="uk-modal" id="modal_default">
            <div class="uk-modal-dialog">
                ...
                <div class="uk-modal-header">
                    <h3 class="uk-modal-title">Design Standerds Referred Details</h3>
                </div>
                ...
                <form action="#" id="form" class="uk-margin-top">
                        ...
                        <div class="uk-width-1-1">
                            <div class="parsley-row md-input-wrapper">
                                <label for="design_standerd_Referred">Design Standerds Referred<span class="req">*</span></label>
                                 
                                <input type="text" name="design_standerd_Referred" required class="md-input label-fixed" />
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#dt_mytable').DataTable({ 
            ...
            "ajax": {
                "url": "<?php echo site_url('project_master/design_standerds_referred/ajax_list')?>",
                "type": "POST"
            },
    ...
    $(document).on('click','.status_checks',function()
    {
        ...
        if(confirm("Are you sure to "+ msg))
        {
            ...
            var myurl="<?php echo base_url()."project_master/design_standerds_referred/update_status"?>";
    ...
    function edit_data(id)
    {
        ...
        $.ajax({
            url : "<?php echo site_url('project_master/design_standerds_referred/ajax_edit')?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data)
            {
                ...
                $('[name="design_standerd_Referred"]').val(data.design_standerd_Referred);
    ...
    function save()
    {
        ...
        if(save_method == 'add') {
            url = "<?php echo site_url('project_master/design_standerds_referred/ajax_add')?>";
        } else {
            url = "<?php echo site_url('project_master/design_standerds_referred/ajax_update')?>";
        }
    ...
    function view_data(id)
    {
        ...
        $.ajax({
            ...
            success: function(data)
            {
                ...
                $('[name="design_standerd_Referred"]').val(data.design_standerd_Referred);
                // Disable text box...
                $('[name="design_standerd_Referred"]').attr("disabled", "disabled");
                $("#btnSave").hide();
    ...
    function delete_data(id)
    {
        UIkit.modal.confirm('Are you sure delete?', function(){ 
            $.ajax({
                url : "<?php echo site_url('project_master/design_standerds_referred/ajax_delete')?>/"+id,
                type: "POST",
                dataType: "JSON",
                success: function(data)
                {
        ...
        if(list_id.length > 0)
        {
            ...
            // {
                $.ajax({
                    type: "POST",
                    data: {id:list_id},
                    url: "<?php echo site_url('project_master/design_standerds_referred/ajax_bulk_delete')?>",
                    dataType: "JSON",
                    success: function(data)
                    {
                        if(data.status)
