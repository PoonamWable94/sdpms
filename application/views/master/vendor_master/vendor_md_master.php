<div id="page_content">    
    <div id="page_content_inner">                
        ...
        <div class="md-card-toolbar md-bg-cyan-300" data-toolbar-progress="100">
            <h1 class="md-card-toolbar-heading-text"> Vendor Material Description List 
                <a href="javascript:void(0)" onclick="add_data()" data-uk-tooltip="{pos:'bottom'}" title="Add Material Description"><i class="md-icon material-icons md-color-white">&#xE146;</i></a>
                    ...
                    <div class="uk-grid">                    
                        <div class="uk-width-1-1">
                            <div class="parsley-row md-input-wrapper">
                                ...
                                <input type="text" id="description" name="description" required class="md-input label-fixed" />
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#dt_mytable').DataTable({ 
            ...
            "ajax": {
                "url": "<?php echo site_url('vendor_md/ajax_list')?>",
                "type": "POST"
            },
    ...
    $(document).on('click','.status_checks',function()
    {
        ...
        if(confirm("Are you sure to "+ msg))
        {
            ...
            var myurl="<?php echo base_url()."vendor_md/update_status"?>";
    ...
    function save()
    {
        ...
        if(save_method == 'add') {
            url = "<?php echo site_url('vendor_md/ajax_add')?>";
        } else {
            url = "<?php echo site_url('vendor_md/ajax_update')?>";
        }
    ...
    function edit_data(id)
    {
        ...
        $.ajax({
            url : "<?php echo site_url('vendor_md/ajax_edit')?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data)
            {
    ...
    function delete_data(id)
    {
        UIkit.modal.confirm('Are you sure delete?', function(){ 
            $.ajax({
                url : "<?php echo site_url('vendor_md/ajax_delete')?>/"+id,
                type: "POST",
                dataType: "JSON",
                success: function(data)
                {
        ...
        if(list_id.length > 0)
        {
            ...
            // {
                $.ajax({
                    type: "POST",
                    data: {id:list_id},
                    url: "<?php echo site_url('vendor_md/ajax_bulk_delete')?>",
                    dataType: "JSON",
                    success: function(data)
                    {
                        if(data.status)
