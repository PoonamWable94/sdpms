        ...
        <div class="uk-modal" id="modal_default">
            <div class="uk-modal-dialog">
                ...
                <div class="uk-modal-header">
                    <h3 class="uk-modal-title">Sub Group Details</h3>
                </div>
                    ...
                    <div class="uk-grid">
                        ...
                        <div class="uk-width-1-1">
                            <div class="parsley-row md-input-wrapper">
                                ...
                                <label for="main_group_id">Main Group<span class="req">*</span></label>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        //    "order": [[0, "desc"]] ,
            ...
            "ajax": {
                "url": "<?php echo site_url('Sub_group_1/ajax_list')?>",
                "type": "POST"
            },
    ...
    $(document).on('click','.status_checks',function()
    {
        ...
        if(confirm("Are you sure to "+ msg))
        {
            ...
            var myurl="<?php echo base_url()."Sub_group_1/update_status"?>";
    ...
    function edit_data(id)
    {
        ...
        $.ajax({
            url : "<?php echo site_url('Sub_group_1/ajax_edit')?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data)
            {
                ...
                $('[name="sub_group"]').val(data.sub_group);
    ...
    function save()
    {
        ...
        if(save_method == 'add') {
            url = "<?php echo site_url('Sub_group_1/ajax_add')?>";
        } else {
            url = "<?php echo site_url('Sub_group_1/ajax_update')?>";
        }
    ...
    function delete_data(id)
    {
        UIkit.modal.confirm('Are you sure delete?', function(){ 
            $.ajax({
                url : "<?php echo site_url('Sub_group_1/ajax_delete')?>/"+id,
                type: "POST",
                dataType: "JSON",
                success: function(data)
                {
        ...
        if(list_id.length > 0)
        {
            ...
            // {
                $.ajax({
                    type: "POST",
                    data: {id:list_id},
                    url: "<?php echo site_url('Sub_group_1/ajax_bulk_delete')?>",
                    dataType: "JSON",
                    success: function(data)
                    {
                        if(data.status)
