    ...
    <div id="page_content_inner">        
        <div class="md-card">
            <div class="md-card-toolbar md-bg-cyan-300" data-toolbar-progress="100">
                <h1 class="md-card-toolbar-heading-text"> List All User Roles
                    <a href="javascript:void(0)" onclick="add_data()" data-uk-tooltip="{pos:'bottom'}" title="Add New Role"><i class="md-icon material-icons md-color-white">&#xE146;</i></a>                    
        ...
        <div class="uk-modal" id="modal_default">
            <div class="uk-modal-dialog">
                ...
                <div class="uk-modal-header">
                    <h3 class="uk-modal-title">Role Details</h3>
                </div>
                    ...
                    <div class="uk-grid">
                        ...
                        <div class="uk-width-1-1">
                            <div class="parsley-row md-input-wrapper">
                                ...
                                <input type="text" name="role" id="role" required class="md-input label-fixed" />
...
<script type="text/javascript">
    ...
    $(document).on('click','.status_checks',function()
    {
        ...
        if(confirm("Are you sure to "+ msg))
        {
            ...
            var roleId = $(current_element).attr('data');
            var myurl="<?php echo base_url()."Role/update_status"?>";
    ...
    function view_data(roleId)
    {
        ...
        //Ajax Load data from ajax
        $.ajax({
            url : "<?php echo site_url('Role/ajax_edit')?>/" + roleId,
            type: "GET",
            dataType: "JSON",
            success: function(data)
            {                
