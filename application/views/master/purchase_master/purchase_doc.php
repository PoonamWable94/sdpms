        ...
        <div class="md-card">
            <div class="md-card-toolbar md-bg-cyan-300" data-toolbar-progress="100">
                ...
                <a href="javascript:void(0);"  onclick="goBack()" title="Back" ><i class="md-icon material-icons md-color-white">keyboard_backspace</i></a> 
                    List of All Purchase Documents  
                ...
                <form action="#" id="form" class="uk-margin-top" enctype='multipart/form-data'>
                        ...
                        <div class="uk-width-1-1">
                            <div class="input-box">
                                           ...
                                           <p id="document_file_name">No file chosen</p> <!-- Display the existing file name here -->
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#dt_mytable').DataTable({ 
            ...
            "ajax": {
                "url": "<?php echo site_url('purchase_doc/ajax_list')?>",
                "type": "POST"
            },
    ...
    $(document).on('click','.status_checks',function()
    {
        ...
        if(confirm("Are you sure to "+ msg))
        {
            ...
            var myurl="<?php echo base_url()."purchase_doc/update_status"?>";
    ...
    function edit_data(id)
    {
        ...
        $.ajax({
            url : "<?php echo site_url('purchase_doc/ajax_edit')?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data)
            {
    ...
    function save()
    {
        ...
        if(save_method == 'add') {
            url = "<?php echo site_url('purchase_doc/ajax_add')?>";
        } else {
            url = "<?php echo site_url('purchase_doc/ajax_update')?>";
        }
    ...
    function delete_data(id)
    {
        UIkit.modal.confirm('Are you sure delete?', function(){ 
            $.ajax({
                url : "<?php echo site_url('purchase_doc/ajax_delete')?>/"+id,
                type: "POST",
                dataType: "JSON",
                success: function(data)
                {
        ...
        if(list_id.length > 0)
        {
            ...
            // {
                $.ajax({
                    type: "POST",
                    data: {id:list_id},
                    url: "<?php echo site_url('purchase_doc/ajax_bulk_delete')?>",
                    dataType: "JSON",
                    success: function(data)
                    {
                        if(data.status)
    ...
    $.ajax({
        url: "<?php echo site_url('purchase_doc/download_multiple'); ?>",
        type: "POST",
        data: { ids: selected },
        xhrFields: {
        ...
        success: function(response) {
            ...
            a.href = url;
            a.download = 'Purchase_documents.zip'; // Name of the ZIP file
