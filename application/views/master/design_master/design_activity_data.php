                     ...
                     <div class="uk-grid">
                        ...
                        <div class="uk-width-1-1">
                            ...
                            <label for="activity_data">Activity<span class="req">*</span></label> 
                                <select name="activity" id="activity_id dept" rows="3" cols="5" class="main_group md-input label-fixed" required >
...
<script type="text/javascript">
    ...
    $(document).ready(function() {    
        table = $('#dt_mytable').DataTable({     
            ...
            "ajax": {
                "url": "<?php echo site_url('design_activity_data/ajax_list')?>",
                "type": "POST"
            },
    ...
    function edit_data(id)
    {
        ...
        $.ajax({
            ...
            {                
                ...
                //  $('[name="activity_days"]').val(data.activity_days);
