            ...
            <div class="uk-width-medium-1-1 uk-row-first">
                <div class="md-card">                                                       
                    <div class="md-card-toolbar md-bg-cyan-300 " data-toolbar-progress="100">
                        <h1 class="md-card-toolbar-heading-text"> Update Component Sub Activity</h1> 
                    </div>                   
                    ...
                    <div class="uk-overflow-container">                    
                        ...
                        <div class="uk-width-medium-1-1 sticky-col first-col">                                                           
                            <div class="parsley-row md-input-filled">                                
                                ...
                                <a href="<?php echo base_url('productionwindow?projectID=').$projectID;?>" class="md-btn">Back</a>
                            </div>
                        </div>                   
                    </div>                                      
                </div>
...
<script type="text/javascript">
    ...
    function update_sub_activity(){
        ...
        var aUrl = base_url+'productionwindow/update_all_subactivity';
