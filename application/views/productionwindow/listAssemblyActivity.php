...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#dt_mytable').DataTable({ 
            ...
            "ajax": {
                "url": "<?php echo site_url('productionwindow/list_assembly_activity'); ?>",
        ...
        // $('.client_approval_class').on('change',function(){           
            ...
            if(clientApproval != dataApprovalType){
                var myurl= base_url+'productionwindow/update_assembly_client_approval';            
                $.ajax({
                    type:"POST",
                    url:myurl,
        ...
        $(document).on('change','.prod_release_class',function(){        
            ...
            if(prod_release != dataApprovalType){
                var myurl="<?php echo base_url()."productionwindow/update_prod_assembly_release"?>";            
                $.ajax({
                    type:"POST",
                    url:myurl,
    ...
    $(document).on('click','.status_checks',function(){
        ...
        {            
            ...
            var myurl="<?php echo base_url()."productionwindow/update_assembly_status"?>";
    ...
    {
        UIkit.modal.confirm('Are you sure delete Assembly Sub Activity?', function(){ 
            $.ajax({
                url : "<?php echo site_url('productionwindow/delete_new_assembly_sub_activity')?>",
                type: "POST",
                dataType: "JSON",
                ...
                success: function(data)
                {
                    ...
                    reload_table();
                    UIkit.notify({
                        message : 'Assembly Sub Activity Record deleted!',
                        status  : 'danger',
                        timeout : 5000,
                        pos     : 'bottom-center'
                    })
