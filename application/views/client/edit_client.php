            ...
            <div class="uk-width-medium-1-1 uk-row-first">
                ...
                <div class="md-card">
                    <div class="md-card-toolbar md-bg-cyan-300" data-toolbar-progress="100">
                        <h1 class="md-card-toolbar-heading-text"> Update Client 
                    ...
                    <div class="md-card-content">                        
                        ...
                        <form role="form" id="form_validation" action="<?=base_url();?>client/update_client" method="POST" autocomplete="off">                            
