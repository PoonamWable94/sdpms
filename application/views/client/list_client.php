        ...
        <div class="md-card">
            <div class="md-card-toolbar md-bg-cyan-300" data-toolbar-progress="100">
                ...
                <?php if($this->session->userdata('role') != 4) { ?>
                        <a href="<?php echo base_url('client/add_client');?>"  data-uk-tooltip="{pos:'bottom'}" title="Add New Client"><i class="md-icon material-icons md-color-white">&#xE146;</i></a> 
                    <?php } ?>                      
                    ...
                    <table class="uk-table uk-table-align-vertical uk-table-nowrap uk-table-condensed tablesorter tablesorter-altair" id="ts_issues4">
                        <thead>
                            <tr class="table_head">
                                ...
                                <th class="uk-text-center" style="color:#fff">Sr.No</th>
