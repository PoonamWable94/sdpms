                ...
                <div class="md-card">
                    <div class="md-card-toolbar md-bg-cyan-300" data-toolbar-progress="100">
                        ...
                        <a href="javascript:void(0);"  onclick="goBack()" title="Back" ><i class="md-icon material-icons md-color-white">keyboard_backspace</i></a> 
                            Add New Client 
                            <a href="<?php echo base_url('client/');?>" class="spacing-tab" data-uk-tooltip="{pos:'bottom'}" title=""><i class="md-icon material-icons md-color-white">&#xe3c7;</i></a>
                        </h1>
                    </div>
                    <div class="md-card-content">                        
                        <?php $this->load->helper("form"); ?>
                        
                        <form role="form" id="client_form" action="<?=base_url();?>client/add_client" method="POST" autocomplete="off">
                            ...
                            <div class="uk-width-medium-1-1">
                                <div class="parsley-row md-input-filled input-simple">
                                    ...
                                    <input type="text" id="phone_no" name="phone_no" value="<?php echo $this->input->post('phone_no'); ?>" placeholder="Please enter phone no" required class="label-fixed numberOnly">
                            ...
                            <div class="uk-width-medium-1-1">
                                <div class="parsley-row md-input-filled input-simple">
                                    ...
                                    <input type="email" id="email" name="email" value="<?php echo $this->input->post('email'); ?>" placeholder="Please enter email" >                                    
                            ...
                            <div class="uk-width-medium-1-1">
                                <div class="parsley-row md-input-filled input-simple">
                                    ...
                                    <a href="<?=base_url();?>client" class="md-btn">Back</a>                                    
                                </div>
                            </div>                              
                        </form>
                    </div>                                        
