        ...
        <div class="uk-modal" id="modal_default">
            <div class="uk-modal-dialog">
                ...
                <div class="uk-modal-header">
                    <h3 class="uk-modal-title">Add Delay Details</h3>
                </div>
                ...
                <form action="#" id="form" class="uk-margin-top">
                        ...
                        <div class="uk-width-1-1">
                           ...
                           <div class="parsley-row md-input-wrapper" id="raised_by">
                            ...
                            <!--    <input type="text" id="raised_on" name="raised_on" required class="md-input label-fixed lettersOnly"/>-->
                            <!--    <span id="errortag" class="uk-text-danger"></span>-->
                            <!--</div>-->
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#dt_mytable').DataTable({ 
            ...
            "ajax": {
                "url": "<?php echo site_url('delay/ajax_my_list')?>",
                "type": "POST"
            },
