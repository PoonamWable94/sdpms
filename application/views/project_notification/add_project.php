            ...
            <div class="uk-width-medium-1-1 uk-row-first">
                ...
                <div class="md-card">
                    <div class="md-card-toolbar md-bg-cyan-300" data-toolbar-progress="100">
                        <h1 class="md-card-toolbar-heading-text"> Add New Project Notification 
                    ...
                    <div class="md-card-content">                        
                        ...
                        <form role="form" id="Project_notification_log_form" action="<?=base_url();?>project_notification/add_project" method="POST" autocomplete="off">
