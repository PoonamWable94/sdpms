    ...
    <div id="page_content_inner">        
        <div class="md-card">
            <div class="md-card-toolbar md-bg-cyan-300" data-toolbar-progress="100">
                <div class="md-card-toolbar-heading-text"> Activity Notification List                    
                    ...
                    <table class="uk-table uk-table-align-vertical uk-table-nowrap uk-table-condensed tablesorter tablesorter-altair" id="ts_issues4">
                        <thead>
                            <tr class="table_head">
                                ...
                                <th style="color:#fff">Notification Name</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {            
        table = $('#ts_issues4').DataTable({ 
            ...
            "ajax": {
                "url": "<?php echo site_url('notification/activity_notification_log/ajax_list')?>",
                "type": "POST"
            },
