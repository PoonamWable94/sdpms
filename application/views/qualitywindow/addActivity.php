                                            ...
                                            <tbody class="assembly-table-body-<?php echo $activity->activityID.$number; ?> assembly-table-body-init" id="assembly-table-body-init">                                              
                                                ...
                                                ?>  
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" name="manpower[]" id="manpower-<?php echo $assembly->assemblyID; ?>" class="table-manpower-input" value="<?php echo $assembly->manpower; ?>" disabled>
                                                        </td>                                                       
                                                        ...
                                                        <td>
                                                            <a href="javascript:void(0)" class="update_assembly_class" data-uk-tooltip title="Update" data-current-act-days="<?php echo $assembly->activity_days; ?>" data-current-act-hours ="<?php echo $assembly->activity_time_hours; ?>" data-current-act-minutes="<?php echo $assembly->activity_time_minutes; ?>" data-current-order="<?php echo $assembly->sub_act_order; ?>"  data-current-row="<?php echo $assembly->assemblyID; ?>" data-current-comp="<?php echo $activity->activityID.$number; ?>" name="update_assembly-<?php echo $assembly->assemblyID; ?>" id="update_assembly-<?php echo $assembly->assemblyID; ?>"><i class="material-icons md-24 md-color-orange-400">&#xE254;</i></a>                                            
                                ...
                                <tbody>
                                    ...
                                    <?php if(!empty($getAllProductionAssemblyActivity)) { 
                                        ...
                                        <tr class="group_order">
                                            ...
                                            <td class="sticky-col second-col">
                                                <select name="row_order[]" id="row_order-<?php echo $activity->activityID.$number; ?>" class="table-select-dd set_assembly_row_order">
                                                <?php
                                                    for($i = 1; $i <= $total_activity_count; $i++){
                                                ?>                                                                                                                             
                                                    <option value="<?php echo $i.','.$activity->activityID; ?>"<?=$activity->row_order == $i ? ' selected="selected"' : '';?>><?php echo $i; ?></option>                                                    
                                            ...
                                            <tbody class="main-assembly-table-body-<?php echo $activity->activityID.$number; ?> main-assembly-table-body-init" id="main-assembly-table-body-init">                                              
                                                ...
                                                ?>  
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="javascript:void(0)" class="update_assembly_activity_class" data-uk-tooltip title="Update" data-current-act-days="<?php echo $assembly->activity_days; ?>" data-current-act-hours ="<?php echo $assembly->activity_time_hours; ?>" data-current-act-minutes="<?php echo $assembly->activity_time_minutes; ?>" data-current-order="<?php echo $assembly->sub_act_order; ?>"  data-current-row="<?php echo $assembly->assemblyID.$sr_no_for_assembly; ?>" data-current-comp="<?php echo $activity->activityID.$number; ?>" name="update_assembly-<?php echo $assembly->assemblyID.$sr_no_for_assembly; ?>" id="update_assembly-<?php echo $assembly->assemblyID.$sr_no_for_assembly; ?>"><i class="material-icons md-24 md-color-orange-400">&#xE254;</i></a>                                            
        ...
        if((total_act_hours > 0 && activity_time_minutes > 0) || (total_act_hours > 0 && activity_time_minutes <= 0)){
            if(start_date != ''){
                ...
                for(i = 1; i <= total_act_hours; i++){
                    ...
                    console.log(total_time_for_next_day);                  
                }
...
// if no of hours and minutes set for activity
    ...
    $('.update_assembly_class').click(function(){  
        ...
        var total_sub_act_time_before_update = (Number(this_sub_act_days)*24*60) + (Number(this_sub_act_hours*60)) + Number(this_sub_act_minutes);            
        ...
        var total_sub_act_time_after_update = (Number(activity_days)*24*60) + (Number(activity_time_hours*60)) + Number(activity_time_minutes);            
    ...
    $('.update_assembly_activity_class').click(function(){  
        ...
        if(startDate != '' && targetDate != '' && manpower > 0){
            ...
            swal({
                title: "Please enter all fields and try again11!!",                
                icon: "warning",
                buttons: true,
                dangerMode: true,
            });
