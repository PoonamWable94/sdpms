            ...
            <div class="uk-width-medium-1-1 uk-row-first">
                <div class="md-card">                                                       
                    <div class="md-card-toolbar md-bg-cyan-300 " data-toolbar-progress="100">
                        <h1 class="md-card-toolbar-heading-text"> Quality Department- Update Sub Assembly Activity</h1> 
                    </div>                   
                    <h5>&nbsp;&nbsp;&nbsp;&nbsp;Project & Client:- &nbsp;&nbsp;<?php echo $projectNo.' / '.$client_name; ?></h5>
                    <h5>&nbsp;&nbsp;&nbsp;&nbsp;Equipment & TAG No:- &nbsp;&nbsp;<?php echo $projectequipmentName.' / '.$tag_number; ?></h5>
                    <h5>&nbsp;&nbsp;&nbsp;&nbsp;Main Activity:- &nbsp;&nbsp;<?php echo $main_activity_name; ?></h5>
                    ...
                    <div class="uk-overflow-container">                    
                            ...
                            <table id="design_activity" class="uk-table uk-table-striped uk-table-hover uk-text-nowrap">
                                ...
                                <tbody>                                    
                                    ...
                                    ?>                                        
                                            <thead>
                                                <tr>                                                                                                            
                                                    <th class="header_design_next" > Sub Activity</th>                                                                                                        
                        ...
                        <div class="uk-width-medium-1-1 sticky-col first-col">                                                           
                            <div class="parsley-row md-input-filled">                                
                                ...
                                <?php if ($no_data_found == 1){ //no data found ?>                                                                
                                    <a href="<?php echo base_url('add_new_project/myactivities');?>" class="md-btn">Back</a>
                                <?php }else{ ?>
                                    <button type="submit" name="submit" onclick="update_sub_activity()" class="md-btn md-btn-success">Update All</button>
                                    <a href="<?php echo base_url('qualitywindow?projectID=').$projectID;?>" class="md-btn">Back</a>
                                <?php } ?>
                            </div>
                        </div>                   
                    </div>                                      
...
<script type="text/javascript">
    ...
    function update_sub_activity(){
        ...
        var aUrl = base_url+'qualitywindow/update_all_assembly_subactivity';
        ...
        $.ajax({
            ...
            success: function(data, textStatus, jqXHR){ 
                if(data.projectID > 0){
                    ...
                    swal("Sub Activity data updated successfull.")
                        .then((value) => {
