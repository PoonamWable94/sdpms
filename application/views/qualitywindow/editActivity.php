            ...
            <div class="uk-width-medium-1-1 uk-row-first">
                <div class="md-card">                                                       
                    <div class="md-card-toolbar md-bg-cyan-300 " data-toolbar-progress="100">
                        <h1 class="md-card-toolbar-heading-text"> Quality Department- Update Sub-Activity</h1> 
                    </div>                   
                            ...
                            <table id="design_activity" class="uk-table uk-table-striped uk-table-hover uk-text-nowrap">
                                ...
                                <tbody>                                    
                                    ...
                                    ?>                                        
                                            <thead>
                                                <tr>                                                                                                            
                                                    <th class="header_design_next" > Sub Activity List</th>                                                                                                        
                                                ...
                                                ?>  
                                                    <tr>                                                        
                                                        ...
                                                        <td>  
                                                            ...
                                                            <input type="hidden" id="sub_activity" name="sub_activity[]" value="<?php echo $assembly->task_data; ?>">
...
<script type="text/javascript">
    ...
    function update_sub_activity(){
        ...
        var aUrl = base_url+'qualitywindow/update_all_subactivity';
