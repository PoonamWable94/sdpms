<div id="page_content">
    ...
    <div id="page_heading" data-uk-sticky="{ top: 40, media: 960 }">
        <div class="heading_actions">
            <a href="javascript:void(0)" onclick="add_data()" data-uk-tooltip="{pos:'bottom'}" title="Upload New Document   "><i class="md-icon material-icons md-color-green-400">&#xE146;</i></a>
        ...
        <div class="uk-modal" id="modal_default">
            <div class="uk-modal-dialog">
                ...
                <div class="uk-modal-header">
                    <h3 class="uk-modal-title">Manual</h3>
                </div>
                ...
                <form action="#" id="form" class="uk-margin-top" enctype="multipart/form-data">
                    <div class="uk-grid">
                        ...
                        <div class="uk-width-1-1" id="photo-preview">
                            <label for="ManualImage">PDF Document</label>
                        ...
                        <div class="uk-width-1-1">
                            <div id="image_prev" class="parsley-row md-input-wrapper">
                                ...
                                <p name="p1"> Upload Manual PDF Document </p>
                            </div>
                        </div>
                        <div class="uk-width-1-1 uk-margin-top">
                            <div class="parsley-row md-input-wrapper">
                                <label for="ContactPersonName">Ducument Name<span class="req uk-text-danger">*</span></label>
                                <input type="text" name="document_name" required class="md-input label-fixed" />
