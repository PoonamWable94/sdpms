                            ...
                            <table id="design_activity" class="uk-table uk-table-striped uk-table-hover uk-text-nowrap">
                                ...
                                <?php if(!empty($getAllDesignActivity)) { 
                                    ...
                                    <tr class="group_order<?php echo $level_count; ?>  ">                                        
                                        ...
                                        <input type="text" id="activityID-<?php echo $activity->activityID.$number; ?>" name="activityID[]" value="<?php echo $activity->activityID; ?>" >
                                        <input type="text" id="projectID-<?php echo $activity->activityID.$number; ?>" name="projectID" value="<?php echo $activity->projectID; ?>" >
                                        <input type="text" id="projectequipment-<?php echo $activity->activityID.$number; ?>" name="projectequipment" value="<?php echo $activity->projectequipment; ?>" >
                                        <input type="text" id="total_skill_cnt-<?php echo $activity->activityID.$number; ?>" name="total_skill_cnt[]" value="<?php echo $total_skill_cnt; ?>" >
                                        <input type="text" id="activity_data-<?php echo $activity->activityID.$number; ?>" name="activity_data[]" value="<?php echo $activity->activity; ?>" >
                                        <input type="text" id="activity_data_id-<?php echo $activity->activityID.$number; ?>" name="activity_data_id[]" value="<?php echo $activity->activity; ?>" >
...
<script type="text/javascript">
    ...
    // <input type="text" data-current-row="<?php echo $activity->activityID.$number; ?>"
    //  name="targetDate[]" id="targetDate-<?php echo $activity->activityID.$number; ?>"
    //   class="target_date_class" value="<?php echo $activity->targetDate; ?>" style="width:150px;">     
        ...
        $.ajax({
            ...
            success: function(data, textStatus, jqXHR){ 
                if(data.projectID > 0){
                    ...
                    $.ajax({
                        ...
                        success: function(data, textStatus, jqXHR){ 
                            if(data.activityID > 0){
                                // update start date for next activity based on previous activity.                                
                                swal("Activity Updated Successfully. StartDate if").then((value) => {                        
                                    window.location = base_url+'designwindow/addActivity'+'?projectID='+projectID +'&projectequipment='+projectequipment; 
                                });
                            }else{
                                swal({
                                    title: "Something went wrong.. Please try again! StartDate else",                        
                                    icon: "warning",
                                    buttons: true,
                                    dangerMode: true,
                                });
                        ...
                        {
                            swal({
                                title: "Something went wrong.. Please try again!! StartDate error",                                
                                icon: "warning",
                                buttons: true,
                                dangerMode: true,
                            });
                    ...
                    swal({
                        title: "Something went wrong.. Please try again! update else",                        
                        icon: "warning",
                        buttons: true,
                        dangerMode: true,
                    });
            ...
            {
                swal({
                    title: "Please Enter all fields and try again!! update error",                    
                    icon: "warning",
                    buttons: true,
                    dangerMode: true,
                });
