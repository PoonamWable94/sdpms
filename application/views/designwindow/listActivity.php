<?php    
    $csvPath = base_url().'designwindow/export_csv/'.$projectID;
?>
    ...
    <div id="page_content_inner">                
        <div class="md-card">        
            <div class="md-card-toolbar md-bg-cyan-300" data-toolbar-progress="100">
                <h1 class="md-card-toolbar-heading-text"> List Design Activity
    ...
    <div class="uk-modal" id="modal_default">
        <div class="uk-modal-dialog">
            ...
            <div class="uk-modal-header">
                <h3 class="uk-modal-title">Design Activity Details</h3>
            </div>
            ...
            <form action="#" id="show_call_details" class="uk-margin-top">
                <div class="uk-grid"> 
                    <div class="uk-width-1-1">
                        ...
                        <div class="parsley-row md-input-wrapper">
                            <label for="delayDays">Activity Delay </label>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#dt_mytable').DataTable({ 
            ...
            "ajax": {
                "url": "<?php echo site_url('designwindow/list_activity'); ?>",
    ...
    $(document).on('click','.status_checks',function(){
        ...
        {            
            ...
            var myurl="<?php echo base_url()."designwindow/update_status"?>";
    ...
    function view_activity_data(activityID,projectequipment)
    {
        ...
        if(activityID > 0 && projectequipment > 0){
            $.ajax({
                url : base_url+'designwindow/get_activity_detail',
                type: "GET",
                dataType: "JSON",
