                        ...
                        <table id="design_activity" class="uk-table uk-table-striped uk-table-hover uk-text-nowrap">
                            ...
                            ?>                                
                                    <tr>
                                        ...
                                        <td><?php echo wordwrap($activity->activity_data, 50, '<br/>', false); ?> </td>
                                        <td><?php                                             
                                        ...
                                        ?></td>
                                        <td>
                                            <select name="manpower1" id="manpower1" class="manpower-select" >                                              
                                                <option value="1">1</option>                                      
                                                <option value="2">2</option>                                      
                                                <option value="3">3</option>                                      
                                                <option value="4">4</option>                                      
                                        ...
                                        ?></td>                                        
                                        <td>
                                            <!-- <div class="input-box input-calendar input-append date" style="font-size:14px;" id="datetimepicker1">  -->
                                                <!-- <span class="details">Start Date <span class="req">*</span></span> -->
                                                <div id="startDate_time-<?php echo $activity->activityID; ?>" class="input-append date">
                                                    <input class="startDate" type="text" name="startDate" id="startDate">
                                                    <span class="add-on">
                                                        <i data-time-icon="icon-time" data-date-icon="icon-calendar"></i>
                                                    </span>                                                    
                                            ...
                                            <!-- </div> -->
                                            <?php 
                                            // $newStartDate = date('Y-m-d', strtotime($activity->startDate));
                                            // echo $newStartDate.'<br/>'; 
                                            // $newStartTime = date('h:i A', strtotime($activity->startDate));
                                            // echo $newStartTime; 
                                        ?></td>
                                        <td><a href="javascript:void(0)" id="get_target_date" class="md-btn md-btn-success" style="margin-left:5px; height:27px !important; padding-top:0px; font-size:10px;">Date</a></td>
                                        <td>                                                                                   
                                                <input class="targetDate" type="text" name="targetDate" id="targetDate">                                                                                        
                                            <?php 
                                            // $newTargetDate = date('Y-m-d', strtotime($activity->targetDate));
                                            // echo $newTargetDate.'<br/>'; 
                                            // $newTargetTime = date('h:i A', strtotime($activity->targetDate));
                                            // echo $newTargetTime;  
                                        ?></td>
                                        <td><?php 
                                            $clientApproval = 'Yes';
...
// var currDate = "2021-12-01 10:45:00";
    
//     var d = new Date(currDate);
//     var dd = d.setHours(d.getHours() + 1);
//     var dd2 = d.setMinutes(d.getMinutes() + 15);
//     var dd1 = new Date(dd2);

//     console.log(convertToDate(dd1));
</script>